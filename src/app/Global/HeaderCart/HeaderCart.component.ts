...
export class HeaderCartComponent implements OnInit, OnChanges {
  ...
  constructor(public embroService: EmbryoService) {
    this.mobWidth = window.screen.width;
    //  console.log(this.clearStorage);
  }

  ngOnInit() {
    let cartProducts = this.embroService.localStorageCartProducts;
