...
@Component({
  selector: 'embryo-FixedMenu',
  templateUrl: './FixedMenu.component.html',
  styleUrls: ['./FixedMenu.component.scss'],
  animations: [
...
export class FixedMenuComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems,
    public router: Router, public translate: TranslateService, private homeService: HomeTwoService) {
